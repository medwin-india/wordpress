...
$extra_class = '';
$page_column_class = mymedi_page_layout_columns_class($theme_options['ts_prod_cat_layout']);
...
mymedi_breadcrumbs_title($show_breadcrumb, $show_page_title, woocommerce_page_title(false));
?>
	...
	<div id="main-content" class="<?php echo esc_attr($page_column_class['main_class']); ?>">	
		...
		<?php if ( woocommerce_product_loop() ) : ?>
			...
			if( class_exists('WC_Widget_Layered_Nav_Filters') ){
				...
				the_widget('WC_Widget_Layered_Nav_Filters', array('title' => esc_html__('Active filters:', 'mymedi')));
				echo '</div>';
			}
			?>
