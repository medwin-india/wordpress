...
$extra_class = '';
$page_column_class = mymedi_page_layout_columns_class($theme_options['ts_prod_layout']);
...
<div class="related-upsells-products-wrapper" style="background: url(<?php echo esc_url($theme_options['ts_prod_related_upsells_bg']['url']); ?>)">
	<div class="container">
		<?php 
...
<?php endif; ?>
<?php mymedi_product_bottom_content(); ?>
<?php get_footer(); ?>