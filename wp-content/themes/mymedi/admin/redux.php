...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'mymedi' ),
	'page_title'           => esc_html__( 'Theme Options', 'mymedi' ),
	...
	'global_variable'      => 'mymedi_theme_options',
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'General', 'mymedi' )
	,'id'               => 'general-tab'
	,'desc'             => ''
	,'icon'             => 'el el-home'
...
/*** Color Scheme Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Color Scheme', 'mymedi' )
	,'id'               => 'color-scheme-tab'
	,'desc'             => ''
	,'icon'             => 'el el-brush'
...
/*** Typography Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Typography', 'mymedi' )
	,'id'               => 'typography-tab'
	,'desc'             => ''
	,'icon'             => 'el el-font'
...
/*** Header Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Header', 'mymedi' )
	,'id'               => 'header-tab'
	,'desc'             => ''
	,'icon'             => 'el el-lines'
...
/*** Footer Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Footer', 'mymedi' )
	,'id'               => 'footer-tab'
	,'desc'             => ''
	,'icon'             => 'el el-lines'
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Portfolio Details', 'mymedi' )
...
/*** WooCommerce Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'WooCommerce', 'mymedi' )
	,'id'               => 'woocommerce-tab'
	,'desc'             => ''
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Shop/Product Category', 'mymedi' )
...
/*** Product Details Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Product Details', 'mymedi' )
...
/*** Custom Code Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Custom Code', 'mymedi' )
	,'id'               => 'custom-code-tab'
	,'desc'             => ''
	,'icon'             => 'el el-edit'
