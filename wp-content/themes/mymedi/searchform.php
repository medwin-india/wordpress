...
$placeholder_text = esc_html__('Search', 'mymedi');

if( class_exists('WooCommerce') ){
	$placeholder_text = esc_html__('Search for products', 'mymedi');
}
?>
<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" id="searchform<?php echo esc_attr($rand_id); ?>">
	<div class="search-table">
		...
		<div class="search-button">
			<input type="submit" id="searchsubmit<?php echo esc_attr($rand_id); ?>" value="<?php esc_attr_e('Search', 'mymedi'); ?>" />
		</div>
	</div>
</form>