...
$nav_terms = get_terms( 'nav_menu', array( 'hide_empty' => false ) );
...
$footer_blocks = function_exists('mymedi_get_footer_block_options')? mymedi_get_footer_block_options(): array();
