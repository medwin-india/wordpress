...
if( !class_exists('TS_Social_Icons_Widget') ){
	class TS_Social_Icons_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			unset($instance['title'], $instance['custom_text'], $instance['custom_font'], $instance['show_tooltip']);
			...
			<div class="<?php echo esc_attr( implode(' ', $classes) ); ?>">
				<ul class="list-icons">
					...
					<?php endif; ?>
					<?php if( $linkedin_url ): ?>
						<li class="linkedin"><a href="<?php echo esc_url($linkedin_url); ?>" target="_blank" title="<?php echo (!$show_tooltip)?esc_html__('See Us', 'themesky'):''; ?>" ><i class="fab fa-linkedin-in"></i><span class="ts-tooltip social-tooltip"><?php esc_html_e('LinkedIn', 'themesky'); ?></span></a></li>
					<?php endif; ?>
					<?php if( $twitter_url ): ?>
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('linkedin_url'); ?>"><?php esc_html_e('LinkedIn URL', 'themesky'); ?></label>
