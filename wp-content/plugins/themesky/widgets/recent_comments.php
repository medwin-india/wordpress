					...
					<?php foreach( (array) $comments as $comment ): $GLOBALS['comment'] = $comment; ?>
						...
						<?php endif; ?>
							<li>
								...
								<?php if( $show_comment && function_exists('mymedi_string_limit_words') ): ?>
								<blockquote class="comment-body"><?php echo mymedi_string_limit_words(wp_strip_all_tags(get_comment_text()), 15); ?></blockquote>
								<?php endif; ?>
							</li>
