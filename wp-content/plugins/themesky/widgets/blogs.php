...
if( !class_exists('TS_Blogs_Widget') ){
	class TS_Blogs_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$show_comment 		= empty($instance['show_comment']) || !function_exists('mymedi_get_post_comment_count')?0:$instance['show_comment'];
							...
							<li class="<?php echo $post_format ?>">
								...
								<div class="entry-content">								
									...
									<?php if( $show_excerpt && function_exists('mymedi_the_excerpt_max_words') ): ?>
										<div class="excerpt">
											<?php mymedi_the_excerpt_max_words($excerpt_words, $post); ?>
										</div>
									<?php endif; ?>
